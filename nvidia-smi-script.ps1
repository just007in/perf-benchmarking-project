...
nvidia-smi --query-gpu=timestamp,temperature.gpu,utilization.gpu,utilization.memory,clocks.gr,clocks.mem,clocks.video,power.draw,pstate,memory.used --format=csv --loop=1 --filename="$Game"_"$Preset".csv
